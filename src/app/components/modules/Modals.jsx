...
class Modals extends Component {
    ...
    static propTypes = {
        ...
        show_transaction_fee_error_modal: PropTypes.bool,
        ...
        hideTransactionFeeError: PropTypes.func.isRequired,
    ...
    render() {
        const {
            ...
            show_transaction_fee_error_modal,
            show_post_advanced_settings_modal,
            hideLogin,
            hideConfirm,
            show_terms_modal,
        ...
        return (
            <div>
                ...
                {show_transaction_fee_error_modal && (
                    ...
                    >
                        <div>
                            <CloseButton onClick={hideTransactionFeeError} />
                            <h4>{tt('modals_jsx.your_transaction_failed')}</h4>
                            <hr />
                            <h5>
                                {tt('modals_jsx.out_of_transaction_fee_title')}
                            </h5>
                            <p>
                                {tt('modals_jsx.out_of_transaction_fee_reason')}
                            </p>
                            <p>
                                {tt(
                                    'modals_jsx.out_of_transaction_fee_option_title'
                                )}
                            </p>
                            <ol>
                                <li>
                                    {tt(
                                        'modals_jsx.out_of_transaction_fee_option_1'
                                    )}
                                </li>
                            </ol>
