...
export const APP_URL = 'https://blurtlatam.com/';
export const APP_DOMAIN = 'blurtlatam.com';
...
export const LANDING_PAGE_URL = 'https://blurtlatam.com/';
...
export const RECOMMENDED_FOLLOW_ACCOUNT = 'blurtlatam';
